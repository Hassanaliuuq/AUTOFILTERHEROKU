...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b><u>Get More Movies 🎞️ @HDLinks4uu\n\n ᴡᴀɴᴛᴛ ᴛᴏ ꜱᴛʀᴇᴀᴍ ꜰɪʟᴇ ?\n ᴊᴜꜱᴛ ᴄʟɪᴄᴄᴋ ᴏɴ ꜱᴛʀᴇᴀᴍ ʙᴏᴛᴛ ᴀɴᴅᴅ ꜰᴀʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰꜰɪʟᴇᴇ ᴛᴏ ᴛʜᴀᴛ ʙᴏᴛ ᴀɴᴅᴅ ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ. 😊</u></b>",quote=True)
    ...
    k = await msg.reply("<b><u>Get More Movies 🎞️ @HDLinks4uu</u></b>",quote=True)
    await asyncio.sleep(1000000000)
    await msg.delete()
    await k.edit_text("<b>Your File/Video is successfully deleted!!!\n\nClick below button to get your deleted file 👇</b>",reply_markup=InlineKeyboardMarkup(btn))
    return   
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink riplinker.in CAACAgUAAxkBAAEJ4GtkyPgEzpIUC_DSmirN6eFWp4KInAACsQoAAoHSSFYub2D15dGHfy8E\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - https://riplinker.in]]]\n\nIf you have any Doubts, Feel Free to Ask me - @badal6667rai\n\n(Puriyala na intha contact la message pannunga - @badal6667rai)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
