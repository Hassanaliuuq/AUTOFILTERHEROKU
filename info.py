...
BOT_TOKEN = environ.get('BOT_TOKEN', "6657399606:AAHVrOp8gCGfXzE98Tj-FE4DmKWH-zWy8DE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002014300927').split()]
